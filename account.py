#A class with operations deposit, open, close, home and withdraw.
...
#This method prints the main menu that enables user interact with the banking system.
    def home(self):
